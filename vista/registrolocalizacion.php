...
<br/><br/>
        ...
        <div class="form-group" >
          ...
          <div class="col-md-4" >
          <input id="dir" name="direccion" type="text" placeholder="direccion" class="form-control input-md" required> 
          ...
          <input id="cx" name="cx" type="hidden" placeholder="cx" class="form-control input-md" readonly>
          
          
       
          <input id="cy" name="cy" type="hidden" placeholder="cy" class="form-control input-md" readonly>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">                                    
           <button type="submit" id="boton" class="btn btn-success" name="action" value="create">Grabar</button>
